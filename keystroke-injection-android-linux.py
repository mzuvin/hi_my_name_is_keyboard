...
while (time.time() - start) < 10:
  try:
    time.sleep(0.05)
    client.send_keypress(Key.H)
    time.sleep(0.05)
    client.send_keypress(Key.A)
    time.sleep(0.05)
    client.send_keypress(Key.C)
    time.sleep(0.05)
    client.send_keypress(Key.K)
    time.sleep(0.05)
    client.send_keypress(Key.E)
    time.sleep(0.05)
    client.send_keypress(Key.D)
    time.sleep(0.05)
    client.send_keypress(Key.B)
    time.sleep(0.05)
    client.send_keypress(Key.Y)
    time.sleep(0.05)
    client.send_keypress(Key.Z)
    time.sleep(0.05)
    client.send_keypress(Key.V)
    time.sleep(0.05)
    client.send_keypress(Key.N)
    time.sleep(0.05)
